...
(function () {
  const STRINGS = {
    ...
    'star.add': 'Star',
    'star.remove': 'Unstar',
    'starred.empty': 'No starred files yet. Star a file from its ⋯ menu.',
    'photos.empty': 'No photos yet — upload some images.',
    'trash.empty': 'Empty trash',
    'trash.emptyConfirm': 'Delete everything in the trash forever?',
    'trash.none': 'Trash is empty.',
    'trash.restore': 'Restore',
    'trash.forever': 'Delete forever',
    ...
    'sel.zip': 'ZIP',
    'sel.delete': 'Delete',
    'sel.deleteConfirm': 'Delete {n} file(s)? This cannot be undone.',
    'sel.moveTitle': 'Move {n} file(s)',
    'sel.moveHere': 'Move here',
    'sel.moveSame': 'The files are already in this folder.',
    'sel.moveSkipped': 'Some files stayed put — a file with the same name already exists there: {names}',
    'sel.moveFail': 'Could not move the files. Try again.',
    'sel.noFolders': 'No folders yet — create one first.',
    ...
    'notif.ev.password-changed': 'Your password was changed. Not you? Reset it right away.',
    'notif.ev.password-reset': 'Your password was reset by email. All other devices were signed out.',
    'notif.ev.2fa-enabled': 'Two-factor authentication is now on.',
    'notif.ev.2fa-disabled': 'Two-factor authentication was turned off.',
    'notif.ev.passkey-added': 'Passkey "{name}" was added to your account.',
    'notif.ev.passkey-removed': 'Passkey "{name}" was removed from your account.',
    'notif.ev.plan-activated': 'Plan activated: {plan} · {gb} GB. Enjoy!',
    ...
    'title.reset': 'Reset password — Kiliw Cloud',
    'reset.title': 'Reset password.',
    'reset.sub': "Enter your account email — we'll send a 6-digit code.",
    'reset.send': 'Send the code',
    'reset.back': 'Back to sign in',
    'reset.codeTitle': 'Check your email.',
    'reset.codeSub': 'If an account exists for {email}, a code is on its way. It expires in 15 minutes.',
    'reset.newPassword': 'New password (min 8 characters)',
    'reset.confirm': 'Set new password',
    'reset.again': 'Start over',
    'reset.noMail': 'Password recovery by email is not set up yet. Contact the site owner.',
    'pk.title': 'Passkeys',
    'pk.hint': 'Sign in with Face ID, Touch ID or your device PIN — no password needed. A passkey never leaves your device.',
    'pk.add': 'Add a passkey',
    'pk.added': 'Passkey added. You can use it to sign in now.',
    'pk.none': 'No passkeys yet.',
    'pk.remove': 'Remove',
    'pk.removeConfirm': 'Remove passkey "{name}"? You will no longer be able to sign in with it.',
    'pk.tooMany': 'You already have 5 passkeys — remove one first.',
    'pk.fail': 'Could not add the passkey. Try again.',
    'pk.unsupported': 'This browser does not support passkeys.',
    'pk.signin': 'Sign in with a passkey',
    'pk.loginFail': 'Passkey sign-in failed. Try again or use your password.',
    ...
    'profile.delete.hint': 'Schedules your account for deletion. You have 7 days to change your mind — signing in again cancels it. After that, everything is gone forever.',
    'profile.delete.start': 'Delete account',
    'profile.delete.confirm': 'Delete forever',
    'delete.prompt': 'Delete your account and ALL files? You can cancel by signing in again within 7 days — after that everything is gone forever.',
    ...
    'auth.restored': 'Welcome back! The scheduled deletion of your account has been cancelled.',
  };
