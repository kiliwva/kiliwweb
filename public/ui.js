...
(function () {
  const STRINGS = {
    ...
    'note.edit': 'Edit',
    'title.editor': 'Editor — Kiliw Cloud',
    'editor.save': 'Save',
    'editor.saving': 'Saving…',
    'editor.saved': 'Saved',
    'editor.fail': 'Could not save. Try again.',
    'editor.loadFail': 'Could not load the file.',
    'editor.docxFail': 'This Word document could not be opened for editing.',
    'editor.docxWarn': 'Simple Word documents only: text, headings, bold/italic/underline and bullet lists survive saving. Tables, images and advanced layout will be lost.',
    'sel.toggle': 'Select',
