...
(function () {
  const I18N = {
    ...
    ru: {
      ...
      'plan.upgrade': 'Выбрать тариф Pro',
      'plan.benefit1': 'Файлы до 50 ГБ вместо 1 ГБ',
      'plan.benefit2': 'Хранилище от 250 ГБ до 1 ТБ вместо 10 ГБ',
      'plan.benefit3': 'Все возможности бесплатного тарифа: папки, предпросмотр, 2FA',
      'plan.compareFree': 'Бесплатный тариф: 1 ГБ на файл и 10 ГБ хранилища.',
      'plan.perMonth': '/ 30 дней',
      'plan.period': 'Разовый платёж, действует 30 дней.',
