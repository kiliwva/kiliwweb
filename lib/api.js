...
export function verificationEmail(code) {
  const subject = `${code} — your Kiliw verification code`;
  const text = `Your Kiliw verification code: ${code}

It expires in 15 minutes. If you didn't request it, just ignore this email.`;
  const html = `<div style="font-family:Arial,sans-serif;max-width:420px;margin:0 auto;padding:24px">
    ...
    <p style="color:#888;font-size:13px">It expires in 15 minutes. If you didn't request it, just ignore this email.</p>
  </div>`;
