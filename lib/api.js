...
export function buildCodeEmail({ subject, intro, note, code }) {
  ...
  /* The real Kiliw brand tile as a hosted PNG (SVG is stripped by most mail
     clients). The "Kiliw" wordmark sits beside it so the brand still reads
     even where a client blocks remote images. */
  const logo = `<table role="presentation" cellpadding="0" cellspacing="0"><tr>
        <td style="vertical-align:middle;">
          <img src="https://kiliw.com/email-logo.png" width="46" height="46" alt="Kiliw"
               style="display:block;width:46px;height:46px;border:0;outline:none;text-decoration:none;border-radius:12px;">
        </td>
